...
const std::string MODEL_PATH = "..\\Resources\\Models\\qilin.obj";
const std::string TEXTURE_PATH = "..\\Resources\\Textures\\qilin.jpg";
...
private:
    ...
    void createGraphicsPipeline() {
        vk::raii::ShaderModule shaderModule = createShaderModule(readFile("..\\Resources\\Shaders\\shader.slang.spv"));
    ...
    void loadModel() {
        ...
        for (const auto& shape : shapes) {
            for (const auto& index : shape.mesh.indices) {
                ...
                vertex.pos = {
                    attrib.vertices[3 * index.vertex_index + 0] * 0.001f,
                    attrib.vertices[3 * index.vertex_index + 1] * 0.001f,
                    attrib.vertices[3 * index.vertex_index + 2] * 0.001f
                };
        ...
        std::cout << "[Modelo] Total de vértices cargados: " << vertices.size() << std::endl;
    }
